            ...
            <div className="new-businesses-items-box">
                <div className="new-businesses-item">
                    <div className="new-businesses-item-pic-c">
                        <Link to="/businesses/1"><img className="new-businesses-item-pic" src={window.tacoPlace} /></Link>
                    </div>
                    <div className="new-businesses-item-info">
                        <Link to="/businesses/1" className="new-business-item-bname-tacos">Tacos El Gordo</Link>
                        <br/>
                ...
                <div className="new-businesses-item">
                    <div className="new-businesses-item-pic-c">
                        <Link to="/businesses/2"><img className="new-businesses-item-pic" src={window.sushiPlace} /></Link>
                    </div>
                    <div className="new-businesses-item-info">
                        <Link to="/businesses/2" className="new-business-item-bname-sushi">I Heart Sushi</Link>
                        <br/>
                ...
                <div className="new-businesses-item">
                    <div className="new-businesses-item-pic-c">
                        <Link to="/businesses/3"><img className="new-businesses-item-pic" src={window.kbbqPlace} /></Link>
                    </div>
                    <div className="new-businesses-item-info">
                        <Link to="/businesses/3" className="new-business-item-bname-kbbq">JongRo</Link>
                        <br/>
                        <img src={window.fiveStar} className="splash-star" />
